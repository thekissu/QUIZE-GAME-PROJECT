		...
		if (toupper(getch())=='C')
			{
		       ...
		       {
		           printf("\n\nWrong!!! The correct answer is C.NARENDRA MODI");
		           getch();
		       break;
		       }
...
void help()
    ...
    printf("\n    By this way you can win upto ONE MILLION cash prize in RUPIES...............");
    printf("\n >> You will be given 4 options and you have to press A, B ,C or D for the");
    printf("\n    right option");
    printf("\n >> You will be asked questions continuously if you keep giving the right answers.");

	printf("\n\n\t*********************BEST OF LUCK*********************************");
	printf("\n\n\t*****C PROGRAM QUIZ GAME is developed BY KISHAN********");}
